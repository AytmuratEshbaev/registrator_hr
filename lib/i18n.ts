...
export const UI_TRANSLATIONS: TranslationEntry[] = [
  ...
  { uz: "Shinam sinfxonalar", qq: "Shinam klasslar", ru: "Уютные учебные классы" },
  { uz: "Zamonaviy kutubxona", qq: "Zamanagóy kitapxana", ru: "Современная библиотека" },
  { uz: "IT va robototexnika xonasi", qq: "IT hám robototexnika xonası", ru: "Класс IT и робототехники" },
  { uz: "Ilmiy laboratoriya", qq: "Ilimiy laboratoriya", ru: "Научная лаборатория" },
  { uz: "Keng sport zali", qq: "Keń sport zalı", ru: "Просторный спортзал" },
  { uz: "Tasviriy san'at va ijod xonasi", qq: "Súwretlew óneri hám dórediwshilik xonası", ru: "Кабинет искусств и творчества" },
  { uz: "Shinam maktab hovlisi", qq: "Shinam mektep qorası", ru: "Уютный школьный двор" },
  { uz: "Shinam oshxona", qq: "Shinam asxana", ru: "Светлая школьная столовая" },
];
